...
const ACCT = 'test_account';
const A: Actor[] = [
  { id: 'a1', account_id: ACCT, type: 'mentor', name: 'A', profile: {}, expertise: ['x'], capacity: { allocated_units: 3, max_units: 5 }, status: 'active', created_at: '' },
  { id: 'a2', account_id: ACCT, type: 'mentor', name: 'B', profile: {}, expertise: ['y'], capacity: { allocated_units: 7, max_units: 5 }, status: 'active', created_at: '' },
  { id: 'a3', account_id: ACCT, type: 'mentor', name: 'C', profile: {}, expertise: ['z'], capacity: { allocated_units: 0, max_units: 5 }, status: 'active', created_at: '' },
  { id: 'p1', account_id: ACCT, type: 'partner', name: 'P1', profile: {}, expertise: [], capacity: { allocated_units: 0, max_units: 10 }, status: 'active', created_at: '' },
];
...
describe('graph metrics', () => {
  ...
  it('dormantPartners flags partners with last outcome older than 9 months', () => {
    ...
    const outs: Outcome[] = [
      { id: 'o1', account_id: ACCT, relationship_id: 'rX', type: 'session_held', evidence_text: '', source: 'admin', verified: true, timestamp: old },
    ];
    ...
    outs.push({ id: 'o2', account_id: ACCT, relationship_id: 'rX', type: 'session_held', evidence_text: '', source: 'admin', verified: true, timestamp: recent });
